...
**更新** 本次更新重点介绍了增强的目录侧边栏功能，包括动态内容宽度调整、改进的ESC键交互逻辑和优化的移动端体验。
...
**更新** 目录侧边栏现已支持动态内容宽度调整和更智能的ESC键处理逻辑。
...
**更新** 大幅改进了移动端适配，特别是在目录侧边栏与小屏幕设备的兼容性方面。
...
**更新** 性能优化主要体现在CSS transform的使用和更智能的事件处理上。
...
**更新** 最新的重构显著增强了目录侧边栏的功能，包括动态内容宽度调整、改进的ESC键处理和优化的移动端体验，为用户提供了更加流畅和丰富的阅读体验。
