...
### AST Babel demo
- [第一个 babel 插件， babel 初体验]({% post_url 2021/2021-07-27-第一个babel插件 %})
- [Babel 删除未被使用的 function 和由 var,let,const 定义的未使用变量]({% post_url 2021/2021-07-28-Babel删除未被使用的function和由var,let,const定义的未使用变量 %})
- [Babel 还原不直观的编码字符串或数值]({% post_url 2021/2021-07-28-Babel还原不直观的编码字符串或数值 %})
- [Babel 将逗号表达式还原为多个语句]({% post_url 2021/2021-07-29-Babel将逗号表达式还原为多个语句 %})
- [Babel 还原由 var,let,const 定义的未变更的字面量]({% post_url 2021/2021-07-29-Babel还原由var,let,const定义的未变更的字面量 %})
- [Babel 去控制流平坦化之while-switch]({% post_url 2021/2021-07-30-Babel去控制流平坦化之while-switch %})
- [Babel 去控制流平坦化之for-switch]({% post_url 2021/2021-08-01-Babel去控制流平坦化之for-switch %})
- [Babel 将 a['bb'] 转换为 a.bb]({% post_url 2021/2021-08-02-Babel将a['bb']转换为a.bb %})
- [Babel 处理没有参数的自执行函数]({% post_url 2021/2021-08-04-Babel处理没有参数的自执行函数 %})
- [Babel 替换条件确定的if判断或条件表达式代码]({% post_url 2021/2021-08-04-Babel替换条件确定的if判断或条件表达式代码 %})
- [Babel 在参数全为字面量的纯函数调用处替换为其返回值]({% post_url 2021/2021-08-09-Babel在参数全为字面量的纯函数调用处替换为其返回值 %})
- ...

### AST Babel 实战
- [Babel ob 混淆初体验]({% post_url 2021/2021-08-18-Babel-ob混淆初体验 %})


### 推荐阅读
- [Babel 小技巧]({% post_url 2021/2021-07-28-Babel-小技巧 %})
- [Babel 处理 path.evaluate 执行部分 js 全局函数失败]({% post_url 2021/2021-08-03-Babel处理path.evaluate执行部分js全局函数失败 %})
